...
function PreviewPanel() {
  ...
  const hasNoFiles = fileSystem.getAllFiles().size === 0;
    ...
    <div className="h-full bg-white relative">
      ...
      {hasNoFiles && (
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="rounded-lg border border-neutral-200 shadow-sm p-6 w-72 bg-white">
            <h2 className="text-base font-semibold text-neutral-900">No component yet</h2>
            <p className="mt-1 text-sm text-neutral-500">Describe a component in the chat to get started.</p>
          </div>
        </div>
      )}
    </div>
